...
class OriginAirportItemAdapter(val context: Context):RecyclerView.Adapter<OriginAirportItemAdapter.ViewHolder>() {
    ...
    fun setOriginAirports(airportList: MyModelClass){
